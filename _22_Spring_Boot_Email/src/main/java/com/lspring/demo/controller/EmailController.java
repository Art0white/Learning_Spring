...
public class EmailController {
	...
	public String sendAttachmentsMail() {
		...
		try {
			...
			// 传入附件
			FileSystemResource file = new FileSystemResource(new File("E:\\project_java\\Learning_Spring\\_22_Spring_Boot_Email\\src\\main\\resources\\static\\file\\项目文档.docx"));
	...
	public String sendInlineMail() {
		...
		try {
			...
			// 传入附件
			FileSystemResource file = new FileSystemResource(new File("E:\\project_java\\Learning_Spring\\_22_Spring_Boot_Email\\src\\main\\resources\\static\\img\\sunshine.png"));
